...
public class HttpUtils {
	...
	public static String post(String urlStr, String user_country_code, String user_name,String user_passwd)
			throws Exception {
		StringBuffer sb = null;
		String param = "user_country_code=" + user_country_code + "&user_name=" + user_name+"&user_passwd="+user_passwd;
